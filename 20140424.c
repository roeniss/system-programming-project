...
void _execute_command(int *command_flag) {
  switch (buffer->command) {
    case c_help:*command_flag = help();
      break;
    case c_dir:*command_flag = dir();
      break;
    case c_quit:*command_flag = quit();
      break;
    case c_history:
      ...
      *command_flag = 1;
      break;
    case c_dump: *command_flag = dump(buffer->parameter[0], buffer->parameter[1]);
      break;
    case c_edit: *command_flag = edit(buffer->parameter[0], buffer->parameter[1]);
      break;
    case c_fill: *command_flag = fill(buffer->parameter[0], buffer->parameter[1], buffer->parameter[2]);
      break;
    case c_reset: *command_flag = reset();
      break;
    case c_opcode: *command_flag = opcode(buffer->parameter[0]);
      break;
    case c_opcodelist: *command_flag = opcodelist();
      break;
    case c_assemble: *command_flag = assemble(buffer->parameter[0]);
      break;
    case c_type: *command_flag = type(buffer->parameter[0]);
      break;
    case c_symbol: *command_flag = show_symbol();
      break;
    case c_unrecognized: *command_flag = 1;
      break;
  }
  if (*command_flag == 0)
